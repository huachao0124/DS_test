...
train_cfg = dict(_delete_=True, type='IterBasedTrainLoop', max_iters=38038, val_interval=2500)
...
default_hooks = dict(visualization=dict(type='GroundingVisualizationHook'),
                     checkpoint=dict(type='CheckpointHook', interval=2500, by_epoch=False),)
